...
router.post("/", authenticate, requireRole("DEVELOPMENT_TEAM", "FACULTY_COORDINATOR", "STUDENT_COORDINATOR"), validate(givePointsSchema), auditLog("APPRECIATION_POINTS_GIVEN"), async (req: Request, res: Response) => {
  try {
...
router.post("/deduct", authenticate, requireRole("DEVELOPMENT_TEAM", "FACULTY_COORDINATOR", "STUDENT_COORDINATOR"), validate(deductPointsSchema), auditLog("APPRECIATION_POINTS_DEDUCTED"), async (req: Request, res: Response) => {
  try {
...
router.post("/badges", authenticate, requireRole("DEVELOPMENT_TEAM", "FACULTY_COORDINATOR", "STUDENT_COORDINATOR"), validate(createBadgeSchema), async (req: Request, res: Response) => {
  try {
