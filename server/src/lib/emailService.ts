        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%;">
          ...
          <tr>
            <td style="text-align: center; padding-bottom: 30px;">
              ...
              <h1 style="color: #ffffff; font-size: 28px; font-weight: 800; letter-spacing: 6px; margin: 12px 0 0; font-family: 'Courier New', monospace;">SENTINEL</h1>
          ...
          <tr>
            <td style="text-align: center; padding-top: 30px;">
              <p style="color: #475569; font-size: 11px; margin: 0; font-family: 'Courier New', monospace; letter-spacing: 2px;">
                SENTINEL 2.0 // DIGITAL OPERATIONS HUB
              </p>
...
export async function sendAccountApprovedEmail(user: { name: string; email: string }) {
  const content = `
    ...
    <p style="color: #94a3b8; font-size: 14px; line-height: 1.6; margin: 0 0 24px;">
      Your Sentinel account has been <strong style="color: #10b981;">approved</strong>. You now have full access to all member features.
    </p>
    ...
    <p style="color: #64748b; font-size: 12px; line-height: 1.6; margin: 20px 0 0; text-align: center;">
      Welcome to the Sentinel family. Stay sharp, operative.
    </p>
  `;
...
export async function sendRoleUpdatedEmail(
  ...
  const content = `
    ...
    <p style="color: #94a3b8; font-size: 14px; line-height: 1.6; margin: 0 0 24px;">
      Your clearance level within the Sentinel has been updated.
    </p>
