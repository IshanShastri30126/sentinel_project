  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] gap-4 w-full h-full font-mono select-none">
      <div className="relative flex items-center justify-center w-16 h-16">
        ...
        <div className="absolute inset-2 rounded-full border border-green-500/10 border-b-green-500 animate-spin [animation-duration:0.8s] [animation-direction:reverse]" />
      ...
      <div className="flex flex-col items-center gap-1">
        ...
        <span className="text-[9px] text-teal-500/60 uppercase tracking-widest">
          Scanning session attendance logs...
        </span>
      </div>
    </div>
  );
