...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    const facultyUser = user.role === "FACULTY_COORDINATOR" || (user.role as string) === "FACULTY";
    setEditStudentId((facultyUser ? user.employeeId : user.studentId) || user.employeeId || user.studentId || "");
