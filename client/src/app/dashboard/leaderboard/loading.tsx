  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] gap-4 w-full h-full font-mono select-none">
      <div className="relative flex items-center justify-center w-16 h-16">
        <div className="absolute inset-0 rounded-full border border-yellow-500/10 border-t-yellow-500 animate-spin" />
        ...
        <div className="w-2.5 h-2.5 rounded-full bg-yellow-400 animate-pulse shadow-[0_0_8px_rgba(234,179,8,0.8)]" />
      </div>
      <div className="flex flex-col items-center gap-1">
        <span className="text-[10px] text-zinc-500 tracking-[0.25em] uppercase font-bold animate-pulse">
          SORTING SCOREBOARDS
        </span>
        <span className="text-[9px] text-yellow-500/60 uppercase tracking-widest">
          Calculating rank point coefficients...
        </span>
      </div>
    </div>
  );
