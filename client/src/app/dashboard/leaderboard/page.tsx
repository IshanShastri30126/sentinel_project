...
export default function LeaderboardPage() {
  ...
  const isTechOrDev = Boolean(user && ["FACULTY_COORDINATOR", "TECH_COORDINATOR", "STUDENT_COORDINATOR"].includes(user.role));
      ...
      {activeTab === "competition" ? (
        <div className="space-y-6 font-mono">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 p-4 rounded-xl border border-white/[0.08] bg-black/40">
            ...
            {/* Staff Controller Toggle: ADMIN & TECH_COORDINATOR */}
